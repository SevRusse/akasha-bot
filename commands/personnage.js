...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('personnage')
        .setDescription('Affiche la fiche d’un personnage Genshin Impact')
...
Clique sur le lien ci-dessus pour consulter la fiche complète d${('aeiouyé'.includes(perso.nom.toLowerCase()[0]) && !'aeiouyé'.includes(perso.nom.toLowerCase()[1])) ? '\'' : 'e '}**${perso.nom}** sur le site de la Gazette de Teyvat.
                `)
            .setColor(color)
            .setTimestamp();
